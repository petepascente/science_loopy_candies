...
void setup()
{
  ...
  opc.ledGrid(0, 6, 4, width / 2, height / 2, width/70, height/30, 0, true, false);
  ...
  //opc.ledGrid8x8(5 * 64, width * 3/8, height * 3/4, height/16, 0, trueN, false);
